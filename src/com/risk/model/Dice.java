...
/**
 * this class simulate the dice it has method to roll dice
 * 
 * @author Kourosh
 * @version 1.0.0.0
 */
public class Dice implements Comparable {
	...
	/**
	 * this method makes the dice objects comparable it is used in sorting dices
	 */
	@Override
	public int compareTo(Object o) {
		// TODO Auto-generated method stub
		if (this.dice == ((Dice) o).GetDice())
			return 0;
		else if (this.dice > ((Dice) o).GetDice())
			return 1;
		else if (this.dice < ((Dice) o).GetDice())
			return -1;
		return 0;
