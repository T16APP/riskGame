 ...
 * it manages most of the tasks regarding these classes, it hase several
 * properties such as name, lands which is the collection of both
 * countries and continents as well as connectivities which in this application
 * is known as edge
 ...
 * @param prm_name which is string and is the name of the map
 */
 ...
 * @param prm_author, which its type is string, will be the name of the author
 * of the map
 */
 ...
 * @param prm_image, which its type is string, will be the name of the image
 ...
 * 
 * @param prm_name, which is the name of the country or continent
 ...
 */
	 ...
	 * 
	 * @param id, which is the name of the country or continent
	 * @return a country or a continent
	 */
 ...
 * 
 * @param prm_continent is the continent to be removed
 * @return a string which is successful if it is removed and 
 * if it does not exist, notExist will be returned
 */
 ...
 * 
 * @param prm_name is the name of the country under question
 ...
 */
	 ...
	 * 
	 * @param prm_name is the name of the continent under question
	 * @return a boolean which is true if exists otherwise false
	 */
 ...
 * 
 * @param prm_edge which is the edge to be added
...
/**this method adds a country, before adding verifies 
 * if already exists
 * @param prm_name is the name of the country
 * @param prm_continentId is the id of the continent to which the country
 * belongs
 * @param prm_x is x coordinate of the country
 * @param prm_y is y coordinate of the country
 * @return
 */
 ...
 * 	
 * @param prm_edge is the edge under question
 ...
 * 
 * @param prm_countryId1 which is the id of the first country of the edge under question
 * @param prm_countryId2 which is the id of the second country
 ...
 * 
 * @param prm_countryId1 is the id of the first country in the edge
 * @param prm_countryId2 is the id of the second country in the edge
 * @return is string and is successful if the edge was added
...
/**this method returns a country which does not belong to a player
 * 	randomly
 ...
 * before adding it verifies if the continent does exist before
 * @param prm_name is the name of the continent
 * @param prm_control ,which its type is integer, is the control of the continent
 * @return
 */
 ...
 * 
 * @param prm_playerId is the id of the given player
 ...
 * 	 
 * @param prm_countryId is the id of the country
 ...
 * 
 * @param new_name is the name of the continent to be returned
 ...
 * 
 * @param prm_countryId is the id of the given country
 ...
 * 
 * @param prm_name is the name of the country to be return
 ...
 * 
 * @param prm_name is the name of the country to be returned
 ...
 * 	
 * @param prm_countryId is the id of the country under question
 ...
 * 
 * @param prm_continent is the country under question
 * @return true if the country exists otherwise false
 */
 ...
 * 
 * @param prm_country is the country to be removed
 * @return is successful if the country was removed
 ...
 * 
 * @param prm_id is the id of the continent
 ...
 */
	 ...
	 * 
	 * @param prm_id is the id of the country
 ...
 * 	
 * @param prm_continentId is the id of the continent
 ...
 */
	...
	/**this method returns the list of the name of countries
