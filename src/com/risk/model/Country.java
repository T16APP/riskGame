...
public class Country extends Land {
	 ...
	 *            ,which is integer, is the id of the continent to which the
	 *            country belongs
	 * @param prm_x
	 ...
	 * 
	 * @param prm_playerId,
	 *            which is integer, The id of the player who will own the
	 *            country
	 */
	 ...
	 * 
	 * @return continentId, which is integer, The id of the continent to which
	 *         the country belongs
	 */
	...
	/**
	 * this method returns the list of neighbors that exist in the same
	 * continent
	 * 
