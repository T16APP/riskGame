...
/**
 * This class represents a connection between two countries
 * it maintains id of two countries which are neighbor
 * it has different methods to change and set the state of the object
...
/**
 * This the constructor of the edge which
 * set the object id and id of the two neighbor countries
 * @param prm_countryId1, which is integer, is the id of the first country
 * @param prm_countryId2, which is integer, is the id of the second country
 */
	 ...
	 * @return, which is integer, is the id of the object
	 */
	public int GetId()
	{
      return this.id;
	 ...
	 * @param o, which is an edge, is an edge which will be compared to the object 
	 * in terms of the id of the neighbor countries
	 *@return an integer which could be 0 or -1, 0 means that two edges are equal and -1 means the two edges are not equal
	 */
	...
	/**
	 * this method returns the neighbor of a given country
	 * in the current edge
	 * @param prm_countryId , which is integer, is the id of a given country
	...
	/**
	 * the method verifies if the current edge contains
	 * a given country
	 * @param prm_countryId ,which is integer, is the id of the country 
	 * under query 
	 * @return a boolean type which is true if the country 
	 * under the query is contained in the current edge
	 */
